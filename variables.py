...
HERB_VISION_CONE_LENGTH = 150           # Length of vision cones, in units
HERB_VISION_CONE_WIDTH = math.pi/4      # Width of vision cones, in radians
...
HERB_LIFESPAN_MIN = 7500                # Minimum ticks to live for
HERB_LIFESPAN_MAX = 10000               # Maximum ticks to live for
...
CARN_ENERGY_GAIN_PERCENT = 0.233        # Percentage of an herbivore's energy carnivores gain upon eating
...
CARN_LIFESPAN_MIN = 10000               # Minimum ticks to live for
