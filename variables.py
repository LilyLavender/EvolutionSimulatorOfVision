...
SYS_START_PLANT_NUM = 1200
SYS_START_HERB_NUM = 200
SYS_START_CARN_NUM = 80
SYS_GRAPH_MEMORY = 100000   # Amount of ticks visible on the graph
SYS_DEATH_WINDOW_SIZE = 50  # Amount of ticks used to calculate death cause percentage
SYS_SPEED_LEVELS = [0, 1, 2, 4, 8, 16, 32]
SYS_MAX_CLICK_DIST = 20     # Units away from an organism you can click on it from
...
PLANT_SIZE = 12
PLANT_COLOR_MUTATE_RAND = 10            # Amount (in decimal) an organism's color components are allowed to fluctuate per generation
...
PLANT_REPRODUCTION_FRAME_MAX = 600
PLANT_REPRODUCTION_START_FRAME_MIN = 300
PLANT_REPRODUCTION_START_FRAME_MAX = 600
...
HERB_COLOR_MUTATE_RAND = 20             # Amount (in decimal) an organism's color components are allowed to fluctuate per generation
HERB_RADIUS_START = 16                  # Size at the beginning of the sim
HERB_NN_HIDDEN_SIZE = 6                 # Number of hidden neurons
HERB_VISION_CONE_LENGTH = 130           # Length of vision cones, in units
HERB_VISION_CONE_WIDTH = math.pi/4.5    # Width of vision cones, in radians
HERB_METABOLISM = 0.022                 # Energy units lost per tick
HERB_METABOLISM_SPEED_ADD_INV = 120     # Additional energy units lost per tick when moving (as a divisor)
...
HERB_ENERGY_GAIN = 18                   # Energy units to gain when eating a plant
HERB_REPRODUCTION_THRESHOLD = 300       # Energy units required to reproduce
HERB_REPRODUCTION_RETURN = 75           # Energy units to return to after reproduction (plus any excess)
HERB_BORN_ENERGY = 75                   # Energy units new organisms start with
...
HERB_LIFESPAN_MAX = 7000                # Maximum ticks to live for
HERB_GESTATION_PERIOD = 200             # Ticks before being able to give birth again
...
CARN_COLOR_MUTATE_RAND = 24             # Amount (in decimal) an organism's color components are allowed to fluctuate per generation
...
CARN_METABOLISM = 0.072                 # Energy units lost per tick
...
CARN_SPEED_MUL = 3.0                    # Units per frame an organism moves when moving foward, multiplied by their speed neuron strength
CARN_SPEED_MUL_REV = 1.3                # Units per frame an organism moves when moving backward, multiplied by their speed neuron strength
CARN_ENERGY_GAIN_PERCENT = 0.29         # Percentage of an herbivore's energy carnivores gain upon eating
CARN_REPRODUCTION_THRESHOLD = 300       # Energy units required to reproduce
CARN_REPRODUCTION_RETURN = 90           # Energy units to return to after reproduction (plus any excess)
CARN_BORN_ENERGY = 90                   # Energy units new organisms start with
CARN_ENERGY_START_MIN = 70              # Minimum energy units organisms start with on simulation start
CARN_ENERGY_START_MAX = 120             # Maximum energy units organisms start with on simulation start
CARN_LIFESPAN_MIN = 6000                # Minimum ticks to live for
