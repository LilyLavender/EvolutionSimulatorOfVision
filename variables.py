...
HERB_METABOLISM = 0.020                 # Energy units lost per tick
...
CARN_METABOLISM = 0.055                 # Energy units lost per tick
...
CARN_ENERGY_GAIN_PERCENT = 0.35         # Percentage of an herbivore's energy carnivores gain upon eating
CARN_REPRODUCTION_THRESHOLD = 300       # Energy units required to reproduce
CARN_REPRODUCTION_RETURN = 110          # Energy units to return to after reproduction (plus any excess)
CARN_BORN_ENERGY = 110                  # Energy units new organisms start with
